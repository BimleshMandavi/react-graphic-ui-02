...
//         {/* Address */}
//         <div className="sm:mr-[580px] text-center sm:text-start  ml-14 sm:ml-0 " style={{ transform: 'translateX(-0.7in)' }}>
//           <h5 className="text-lg font-semibold mb-4  text-[#908134]">ADDRESS</h5>
//           <p className="hover:text-sky-800 cursor-pointer">Address</p>
//         </div>

//         {/* Get in Touch */}
//         <div className="sm:ml-40  text-center sm:transform sm:translate-x-[0.9px]">
